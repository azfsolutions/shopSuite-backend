...
export class VariantsController {
    ...
    findOptions(
        ...
        return this.variantsService.findOptions(userId, productId);
    }
    ...
    createOption(
        ...
        return this.variantsService.createOption(userId, productId, dto);
    }
    ...
    updateOption(
        ...
        return this.variantsService.updateOption(userId, optionId, dto);
    }
    ...
    deleteOption(
        ...
        return this.variantsService.deleteOption(userId, optionId);
    }
    ...
    addOptionValue(
        ...
        return this.variantsService.addOptionValue(userId, optionId, dto);
    }
    ...
    deleteOptionValue(
        ...
        return this.variantsService.deleteOptionValue(userId, valueId);
    }
    ...
    findVariants(
        ...
        return this.variantsService.findVariants(userId, productId);
    }
    ...
    createVariant(
        ...
        return this.variantsService.createVariant(userId, productId, dto);
    }
    ...
    generateVariants(
        ...
        return this.variantsService.generateVariants(userId, productId, dto);
    }
    ...
    updateVariant(
        ...
        return this.variantsService.updateVariant(userId, variantId, dto);
    }
    ...
    deleteVariant(
        ...
        return this.variantsService.deleteVariant(userId, variantId);
    }
    ...
    bulkUpdateVariants(
        ...
        return this.variantsService.bulkUpdateVariants(userId, productId, dto);
    }
    ...
    getStockSummary(
        ...
        return this.variantsService.getStockSummary(userId, productId);
    }
    ...
    findVariantById(
        ...
        return this.variantsService.findVariantById(userId, variantId);
    }
}
